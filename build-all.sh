...
./configure
make libjicmp6.la jicmp6.jar dist

make dist
make -f /usr/share/selinux/devel/Makefile JICMP6.pp
rm -f JICMP6.pp.bz2
bzip2 -9 JICMP6.pp
...
install -c -m 644 .libs/libjicmp6.so tmp/dist/deb/usr/lib/jni/
install -c -m 644 jicmp6.jar         tmp/dist/deb/usr/share/java/
...
install -c -m 644 .libs/libjicmp6.so "tmp/dist/rpm/usr/${LIBDIR}"
install -c -m 644 jicmp6.jar         "tmp/dist/rpm/usr/share/java/"
install -c -m 644 JICMP6.pp.bz2      "tmp/dist/rpm/usr/share/selinux/packages"
